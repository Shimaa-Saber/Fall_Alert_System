                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Align(
                          alignment: Alignment.centerLeft,
                          child: Text('Are you sure you want to log out?',maxLines: 2,style:
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            }, child: Text('Cancle',style: TextStyle(fontSize: 20.sp,fontWeight: FontWeight.w900,color: Colors.black),)),
                            TextButton(onPressed: (){
                              context.read<AuthCubit>().logout();
                            },
                                child: Text('Log out',style: TextStyle(fontSize: 20.sp,fontWeight: FontWeight.w900,color: Colors.red),))
